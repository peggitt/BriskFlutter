  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        titleSpacing: 0,
        title: Text(
          getTranslation(context, 'account_detail.loan'),
          style: appBarStyle,
        ),
      ),
      body: ListView(
        ...
        children: [
          ...
          heightSpace,
          detailTile(
              getTranslation(context, 'account_detail.loan_disbursement'), returnLoanDetails[0]['disbursement'].toString()),
          heightSpace,
          detailTile(
              getTranslation(context, 'account_detail.loan_paid'), returnLoanDetails[0]['paid'].toString()),
          heightSpace,
          detailTile(getTranslation(context, 'account_detail.balance'),returnLoanDetails[0]['balance'].toString()),
          heightSpace,
          detailTile(
              getTranslation(context, 'account_detail.loan_arrears'),returnLoanDetails[0]['arrears'].toString()),
          heightSpace,
          detailTile(getTranslation(context, 'account_detail.loan_penalty'), returnLoanDetails[0]['penalty'].toString()),
          heightSpace,
          heightSpace,
          heightSpace,
          heightSpace,
