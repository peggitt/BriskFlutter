    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          heightSpace,
          detailTile(
              getTranslation(context, 'account_detail.CIF'), returnAccountDetails[0]['CurrencyId'].toString()),
          heightSpace,
          detailTile(
              getTranslation(context, 'account_detail.IFSC'), returnAccountDetails[0]['ProductType'].toString()),
          heightSpace,
          detailTile(
              getTranslation(context, 'account_detail.branch_code'), returnAccountDetails[0]['BranchId'].toString()),
          heightSpace,
          detailTile(getTranslation(context, 'account_detail.branch_name'),
              returnAccountDetails[0]['BranchName'].toString()),
          heightSpace,
          detailTile(
              getTranslation(context, 'account_detail.account_opening_date'),
              returnAccountDetails[0]['OpenedDate'].toString()),
          heightSpace,
          detailTile(getTranslation(context, 'account_detail.MMId'), returnAccountDetails[0]['OperatingMode'].toString()),
          heightSpace,
          heightSpace,
          heightSpace,
          heightSpace,
