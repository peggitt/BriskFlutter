    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          detailTile(
              getTranslation(context, 'account_detail.balance'), returnLoanBalance[0]['loan_balance'].toString()),
          heightSpace,
          detailTile(
              getTranslation(context, 'account_detail.loan_penalty'), returnLoanBalance[0]['unpaid_penalty'].toString()),
          heightSpace,
          detailTile(
              getTranslation(context, 'account_detail.total_balance'), returnLoanBalance[0]['total_balance'].toString()),
          heightSpace,
          heightSpace,
          heightSpace,
          heightSpace,
