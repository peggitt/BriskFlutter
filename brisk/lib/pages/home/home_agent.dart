...
class _HomeScreenAgentState extends State<HomeAgentScreen> {
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      FormatDateData(statementData[index]['TrxDate'].toString()),
                      style: bold15Black33,
                    ),
                    heightBox(3.0),
                    Text(
                      statementData[index]['Description'].toString(),
                      style: bold12Grey94,
                    )
                  ],
                ),
  ...
  serviceList(Size size) {
    return GridView.count(
      ...
      children: [
        ...
        GestureDetector(
          onTap: () {
            Navigator.pushNamed(context, '/Agentservices');
          },
          child: Container(
            padding: const EdgeInsets.all(fixPadding),
            decoration: BoxDecoration(
