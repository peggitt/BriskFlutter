...
class _CustomersScreenState extends State<CustomersScreen> {
  final tabbarlist = [
    translation('customer.customer_create'),
    translation('customer.customer_view')
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        titleSpacing: 0,
        title: Text(
          getTranslation(context, 'customer.customer_details'),
          style: appBarStyle,
        ),
      ),
      body: Column(
    ...
    return Expanded(
      child: ListView(
        ...
        children: [
          ...
          heightSpace,
          textFieldWidgetEditable(getTranslation(context, 'customer.customer_fname'),
              newFirstName, TextInputType.text),
          height5Space,
          heightSpace,
          textFieldWidgetEditable(getTranslation(context, 'customer.customer_mname'),
              newMiddleName, TextInputType.text),
          height5Space,
          heightSpace,
          textFieldWidgetEditable(getTranslation(context, 'customer.customer_sname'),
              newLastName, TextInputType.text),
          height5Space,
          heightSpace,
          textFieldWidgetEditable(getTranslation(context, 'customer.customer_idno'),
              newIDNo, TextInputType.number),
          height5Space,
          heightSpace,
          textFieldWidgetEditable(getTranslation(context, 'customer.customer_mobile'),
              newMobileNo, TextInputType.number),
          height5Space,
          heightSpace,
          textFieldWidgetEditable(getTranslation(context, 'customer.customer_email'),
          ...
          height5Space,
          Text(
              getTranslation(context, 'customer.customer_documents'),
              style: bold17Black33,
          ...
          uploadBoxWidget(
              getTranslation(context, 'customer.customer_passport')),
          heightSpace,
          height5Space,
          newGroupButton(),
          heightSpace,
  ...
  newGroupButton() {
    return GestureDetector(
      onTap: () async {
        ...
        if (newF == '' || newM == '' || newL== '' || newId== '' || newMobile== '' || newEmailData== '')
        {
        ...
        }else
        {
          ...
          print('Calling Customer Create Details..');

          try {
            var response = await http.post(
              Uri.parse(APICreateCustomerDetails),
              body: jsonEncode(requestBody),
              headers: headers,
            );
            Map<String, dynamic> jsonResponse = json.decode(
            ...
            }else
            {
              ...
              returnDetails = jsonResponse['returnDetails'];
                ...
                showInfoMessage('Customer detailed Added');
      ...
      child: Container(
        ...
        alignment: Alignment.center,
        child: Text(
          getTranslation(context, 'customer.customer_add'),
          style: bold18White,
        ),
      ),
    );
